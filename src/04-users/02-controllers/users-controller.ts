...
import {InputUserQueryType, InputUserType, OutputUserQueryType, OutputUserType} from "../../types/input-output-types/user-type";
...
export const getUsers = async (req: Request<{}, {}, {}, Partial<InputUserQueryType>>,
